...
<body>
	<div class="chk-top thank-top">
    	<div class="container">
			<img src="images/logo.png" alt="" class="logo">
        </div>
    </div>
    
    <div class="chk-cont thank-cont">
    	<div class="container">
            ...
            <div class="thank-inr">
            	<div class="thnk-hd">
                	<img src="images/frm-hd-arw.png" alt="" class="thnk-hd-arw">
            		<p class="thnk-hd-txt1">Congratulations!</p>
                    <p class="thnk-hd-txt2">You've taken the first step towards better health!</p>
                </div>
                <p class="thank-sub-hd">Your E-Books Are Ready<br class="show-mob"> For Download</p>
                
                <div class="thank-prd-bx">
                    ...
                    <div class="thank-prd-info">
                        ...
                        <a href="./assets/Keto-Smart-Guide.pdf" download class="thank-btn">Download Smart Keto Guide <img src="images/download-icn.png" alt=""></a>
                    </div>
                </div>
                
                <img src="images/thank-prd-sepr.png" alt="" class="thank-prd-sepr">
                ...
                <div class="thank-prd-bx">
                    ...
                    <div class="thank-prd-info">
                        ...
                        <a href="./assets/Keto-Smart-Recipe-Book.pdf" download class="thank-btn">Download Smart Recipe Book <img src="images/download-icn.png" alt=""></a>
                    </div>
                </div>
            </div>
